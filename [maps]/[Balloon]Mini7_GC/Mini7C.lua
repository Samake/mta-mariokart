...
function(resource)
	if (resource == getThisResource()) then
		for i = 1, maxObjects do
			objectTexture = engineLoadTXD("models/mini7.txd")
			objectModel = engineLoadDFF("models/mini7" .. i .. ".dff", objectID + i)
			objectCol = engineLoadCOL("models/mini7" .. i .. ".col")
		...
		local sound = playSound("sounds/Balloon_Battle.ogg", true)
