...
function(resource)
	if (resource == getThisResource()) then
		for i = 1, maxObjects do
			objectTexture = engineLoadTXD("models/diddy.txd")
			objectModel = engineLoadDFF("models/diddy" .. i .. ".dff", objectID + i)
			objectCol = engineLoadCOL("models/diddy" .. i .. ".col")
		...
		local sound = playSound("sounds/diddy_mountain.ogg", true)
