...
function(resource)
	if (resource == getThisResource()) then
		for i = 1, maxObjects do
			objectTexture = engineLoadTXD("models/yoshi.txd")
			objectModel = engineLoadDFF("models/yoshi" .. i .. ".dff", objectID + i)
			objectCol = engineLoadCOL("models/yoshi" .. i .. ".col")
		...
		local sound = playSound("sounds/circuit.ogg", true)
