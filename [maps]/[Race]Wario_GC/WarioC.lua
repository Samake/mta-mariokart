...
function(resource)
	if (resource == getThisResource()) then
		for i = 1, maxObjects do
			objectTexture = engineLoadTXD("models/wario.txd")
			objectModel = engineLoadDFF("models/wario" .. i .. ".dff", objectID + i)
			objectCol = engineLoadCOL("models/wario" .. i .. ".col")
		...
		local sound = playSound("sounds/wario_colloseum.ogg", true)
