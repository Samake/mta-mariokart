...
function(resource)
	if (resource == getThisResource()) then
		for i = 1, maxObjects do
			objectTexture = engineLoadTXD("models/baby.txd")
			objectModel = engineLoadDFF("models/baby" .. i .. ".dff", objectID + i)
			objectCol = engineLoadCOL("models/baby" .. i .. ".col")
		...
		local sound = playSound("sounds/baby_park.ogg", true)
